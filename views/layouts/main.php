    ...
    <header class=" mb-5">
        ...
        <div class="container-xl d-flex flex-column flex-xl-row  align-items-center justify-content-between pt-3 pb-3">
            <div class="logo mb-xl-0 mb-5">
                <a height="100%" href="<?=BaseUrl::home() ?>"><img width="200px" src="assets/Logo.png" alt="Лого"></a>
            </div>
            <form class="d-flex align-items-center mb-xl-0 mb-5 position-relative">
                <label class="svg_search position-absolute" for="search"><img class="ml-2 mt-2" width="36px" src="assets/search.svg" alt="svg"></label>
                ...
                <?=
                    Yii::$app->user->isGuest ? (
                        ...
                        . Html::submitButton(
                            ...
                            ['class' => 'login  btn btn-outline-warning text']
                        )
                        . Html::endForm()
                        )
                ?>
